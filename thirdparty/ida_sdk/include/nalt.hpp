...
//--------------------------------------------------------------------------
#ifndef SWIG // IDAPython has its own wrapper for switch_info_ex_t
...
typedef qvector<const custom_refinfo_handler_t *> custom_refinfo_handlers_t;
