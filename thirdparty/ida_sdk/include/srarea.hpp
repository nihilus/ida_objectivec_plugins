...
DECLARE_TYPE_AS_MOVABLE(segreg_t);
...
//      value - its default value. this value will be used by get_segreg()
...
inline
size_t ida_export get_srareas_qty(void) { return SRareas.get_area_qty(); }
...
inline
segreg_t *get_srarea(ea_t ea) { return (segreg_t *)(SRareas.get_area(ea)); }
...
inline
segreg_t *getn_srarea(int n) { return (segreg_t *)(SRareas.getn_area(n)); }
