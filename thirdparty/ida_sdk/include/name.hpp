...
//      bufsize - size of the buffer with the name
// returns: NULL-can't validate
//          name-ok,validated name

idaman char *ida_export validate_name2(char *name, size_t bufsize);
...
idaman DEPRECATED char *ida_export validate_name(char *name); // use validate_name2()
#endif
