...
//      temp_file_ptr - out: will point to the name of the file that
//                           contains the extracted module
// returns: true-ok, false-something bad happened (error message has been displayed to the user)
...
// since uninitalized enums are forbidden in C++, define dev_code_t as int
