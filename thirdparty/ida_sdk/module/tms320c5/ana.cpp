...
// 0011 1111 MDDD DDDD          TMS2_ltd
    case 3:
      if ( subcode < 8 ) {
        ...
        static const uchar codes[8] = { TMS2_mpy,TMS2_sqra,TMS2_mpya,TMS2_mpys,
...
// 0100 1111 MDDD DDDD          TMS2_subb
    case 4:
      {
        static const ushort codes[16] = { TMS2_zalh,TMS2_zals,TMS2_lact,TMS2_addc,
...
// 0101 1111 1DDD DDDD +1       TMS2_bnc
    case 5:
      {
        static const ushort codes[16] = { TMS2_lst, TMS2_lst1,TMS2_ldp, TMS2_lph,
...
// 0111 1111 KKKK KKKK          TMS2_sbrk
    case 7:
      if ( subcode < 8 ) {
        ...
        static const ushort codes[8] = { TMS2_sst,TMS2_sst1,TMS2_popd,TMS2_zalr,
  ...
  if ( isC2() ) { if ( !ana_c2() ) return 0; }
    ...
    case 0:
      if ( subcode < 8 ) {
        ...
        {
          static const uchar codes[8] = { TMS_lamm,TMS_smmr,TMS_subc,TMS_rpt,
...
case08_common:
    ...
    case 8:
      if ( subcode < 8 ) {
        ...
        static const uchar codes[8] = { TMS_samm,TMS_lmmr,TMS_popd,TMS_mar,
      ...
      switch ( subcode ) {
        ...
        case 0xF:
          ...
          switch ( (code>>4) & 0xF ) {
            ...
            case 0xD:
              {
                static const uchar codes[] = { TMS_lacc,TMS_add,TMS_sub,TMS_and,
                                               TMS_or,  TMS_xor
                                       };
